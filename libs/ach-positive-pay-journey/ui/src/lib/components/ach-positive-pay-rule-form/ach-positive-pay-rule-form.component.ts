...
import { ACH_POSITIVE_PAY_TRANSLATIONS } from '../../config/constants/dynamic-translations';

@Component({
  selector: 'bb-ach-positive-pay-rule-form',
  templateUrl: './ach-positive-pay-rule-form.component.html',
  imports: [AccountSelectorModule, DropdownSingleSelectModule, InputTextModule],
  standalone: true
})
