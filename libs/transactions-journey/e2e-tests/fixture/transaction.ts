...
import { defaultTransactionMock, defaultTransactionsMock, setupPageMocks } from '../mocks';

export const test = baseTest.extend<TransactionFixture>({  // mocks data setup, can be overridden or bypassed via "useMocks"
