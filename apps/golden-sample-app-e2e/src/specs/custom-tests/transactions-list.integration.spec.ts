...
test.describe(
  ...
  () => {
    ...
    test.describe('Example 1 — Good integration test: single boundary, deterministic mocks', () => {
    ...
    test.describe('Example 2 — Test data setup and cleanup: per-test seed and explicit unrouting', () => {
    ...
    test.describe('Example 3 — External dependency handling: explicit 200 and 500 responses via page.route(...)', () => {
