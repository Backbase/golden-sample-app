...
import { APP_TRANSLATIONS, Translations } from './shared/translations.provider';
...
@Component({
  ...
  providers: [
    { provide: APP_TRANSLATIONS, 
      useValue: { 
        'move-focus-to-beginning-of-content': 'saltar al contenido' 
      } 
    },
  ]
})
export class AppComponent {
  ...
  constructor(
    ...
    this.translations = {
      'move-focus-to-beginning-of-content':
        this.overridingTranslations['move-focus-to-beginning-of-content'] ||
        $localize`:Move focus to beginning of content - 'skip to content'|This string is
      ...
      'skip-to-content':
        this.overridingTranslations['skip-to-content'] ||
        $localize`:Skip to content - 'Skip to content'|This string is used as the text for
      ...
      'bb-layout.sidebar_toggler':
        this.overridingTranslations['bb-layout.sidebar_toggler'] ||
        $localize`:Sidebar Toggler - 'Toggle sidebar'|This string is used as the aria-label
      ...
      'main.transfer.link.text':
        this.overridingTranslations['main.transfer.link.text'] ||
        $localize`:Make transfer link - 'Make transfer'|This string is used as the
      ...
      'main.transactions.link.text':
        this.overridingTranslations['main.transactions.link.text'] ||
        $localize`:Transactions list link - 'Transactions List'|This string is used
      ...
      'main.positive-pay.link.text':
        this.overridingTranslations['main.positive-pay.link.text'] ||
        $localize`:Positive pay link - 'Positive Pay'|This string is used as the text
                for a link that navigates to the Positive Pay page. It is
                presented to the user as a navigation item in the horizontal
                navigation bar. This text is located in the navigation items
                section of the layout.@@main.positive-pay.link.text:Positive Pay`,
      'main.ach-positive-pay.link.text':
        this.overridingTranslations['main.ach-positive-pay.link.text'] ||
        $localize`:Ach Positive pay link - 'ACH Positive Pay'|This string is used as
      ...
      'main.make-a-payment.link.text':
        this.overridingTranslations['main.make-a-payment.link.text'] ||
        $localize`:Make a Payment Link - 'Make internal payment'|This string is used
      ...
      'main.entitlements-test-no-grouping.text':
        this.overridingTranslations['main.entitlements-test-no-grouping.text'] ||
        $localize`:Entitlements Test No Grouping - 'Entitlements Test No Groups'|This string is used
      ...
      'main.entitlements-test-grouping.text':
        this.overridingTranslations['main.entitlements-test-grouping.text'] ||
        $localize`:Entitlements Test Grouping - 'Entitlements Test Groups'|This string is used
                as the text for a link that navigates to the entitlements test
                page. It is presented to the user as a navigation item in the
                horizontal navigation bar. This text is located in the navigation
                items section of the layout.@@main.entitlements-test-grouping.text:Ents. Test Groups`,
      'main.entitlements-test-nested-groups.text':
        this.overridingTranslations[
          'main.entitlements-test-nested-groups.text'
        ] ||
        $localize`:Entitlements Test Nested Groups - 'Entitlements Test Nested Groups'|This string is used
                as the text for a link that navigates to the entitlements test
                page. It is presented to the user as a navigation item in the
                horizontal navigation bar. This text is located in the navigation
      ...
      'main.entitlements-test-using-not-operators-on-groups.text':
        ...
        $localize`:Entitlements Test Using Not Operators On Groups - 'Entitlements Test - Not Operators On Groups'|This string is used
                as the text for a link that navigates to the entitlements test
                page. It is presented to the user as a navigation item in the
                horizontal navigation bar. This text is located in the navigation
      ...
      'main.entitlements-test-using-multiple-not-operators-on-groups.text':
        ...
        $localize`:Entitlements Test Using Multiple Not Operators On Groups - 'Entitlements Test - Multiple Not Operators On Groups'|This string is used
                as the text for a link that navigates to the entitlements test
                page. It is presented to the user as a navigation item in the
                horizontal navigation bar. This text is located in the navigation
