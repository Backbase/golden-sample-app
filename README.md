...
The project uses the latest versions of the tools and libraries.
 ...
 ### Components included in the app
  ...
  - Configure journeys
    - This is [an example](https://github.com/Backbase/golden-sample-app/blob/master/libs/transactions/src/lib/services/transactions-journey-config.service.ts) is how the journey configuration might be defined in the application 
  ...
  - Communication service: communications between journeys
    ...
    - There are 3 parts of the communication chain:
      ...
      - the actual implementation of the service will live on the application level and must implement both of the available interfaces (or abstract classes) from source and destination journeys. Check the example [`journey-communication.service.ts`](https://github.com/Backbase/golden-sample-app/blob/master/apps/golden-sample-app/src/app/services/journey-communication.service.ts)
