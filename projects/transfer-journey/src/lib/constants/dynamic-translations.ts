...
export const TRANSLATIONS = {
  ...
  limitError: (maxLimit: number) => $localize`:make transfer form limit validation error|limit value error form@@transfer.form.limitError:You cannot make a transfer greater than ${maxLimit}`,
};
